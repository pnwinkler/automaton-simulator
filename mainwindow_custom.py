...
from simulator.GUI_custom_scene import clickable_qgraphicsview, svgItem_mod
from simulator.generate_strings_from_regex import *
import simulator.automaton_logic as automaton_logic
import simulator.regex_generator as regex_generator
